...
Функция ОпределитьУникальныйИдентификаторНаСервере(Знач Ссылка)
...
&НаСервереБезКонтекста
Функция ОпределитьСсылкуНаСервере(Знач УникальныйИдентификаторОбъекта, Знач Раздел, Знач ПолноеИмяОбъекта)
