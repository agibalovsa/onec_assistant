...
функция ИнициализироватьПараметрыВыгрузки(Инициализировать = Ложь) Экспорт
	...
	ПараметрыВыгрузки.Вставить("РежимВыгрузкиПоСсылке",                   ?(Инициализировать, Ложь, Неопределено));
	ПараметрыВыгрузки.Вставить("ОчищатьНеВыгружаемыеСсылки",              ?(Инициализировать, Истина, Неопределено));
	ПараметрыВыгрузки.Вставить("СтрогийФорматВыгрузки",                   ?(Инициализировать, Ложь, Неопределено));
	ПараметрыВыгрузки.Вставить("ВыгружатьПомеченныеНаУдаление",           ?(Инициализировать, Ложь, Неопределено));
...
Функция ЗагрузитьДанныеОбъектов(Адрес, ПараметрыВыгрузки) Экспорт
	...
	Если ПараметрыВыгрузки.ОчищатьНеСовпадающиеЭлементыПриЗагрузке Тогда
		УстановитьМонопольныйРежим(Истина);
	КонецЕсли;
	...
	ТранспортДанных = ИнициализироватьТранспортДанных("Загрузка", ПараметрыВыгрузки, ИмяВременногоФайла);
...
//   * Протокол     - См. ИнициализироватьПротокол()
//
Функция ИнициализироватьТранспортДанных(Тип, ПараметрыВыгрузки, ПутьКФайлу = "", XDTOАннотацияТипов = Ложь)
	...
	Если ЗначениеЗаполнено(ПутьКФайлу) Тогда
		...
		ЧтениеДанных.ОткрытьФайл(ПутьКФайлу);
